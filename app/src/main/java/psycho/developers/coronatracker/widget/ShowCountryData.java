 ...
 * App Widget Configuration implemented in {@link ShowCountryDataConfigureActivity ShowCountryDataConfigureActivity}
 */
public class ShowCountryData extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.show_country_data);
